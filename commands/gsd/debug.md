...
```bash
INIT=$(node C:/Users/gilad/.claude/get-shit-done/bin/gsd-tools.js state load)
```

Extract `commit_docs` from init JSON. Resolve debugger model:
```bash
DEBUGGER_MODEL=$(node C:/Users/gilad/.claude/get-shit-done/bin/gsd-tools.js resolve-model gsd-debugger --raw)
```
